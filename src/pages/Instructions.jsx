...
const FreeGameInstructions = () => {
    return (
        <Fragment>
            <Helmet><title>Game Instructions</title></Helmet>
            <div className="instructions container">
                ...
                <ul className="browser-default" id="main-list">
                    ...
                    <li>Feel free to quit (or retire from) the game at any time. In that case, your score will be revealed afterward.</li>
...
export default FreeGameInstructions;
